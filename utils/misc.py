...
# ---------------------------- For Dataset ----------------------------
## build dataloader
def build_dataloader(default_config, dataset, batch_size, collate_fn=None):
    ...
    dataloader = DataLoader(dataset, batch_sampler=batch_sampler_train,
                            collate_fn=collate_fn, num_workers=default_config['num_workers'], pin_memory=True)
    
    return dataloader
    
## collate_fn for dataloader
class CollateFunc(object):       # 实现一个类，用于对数据进行预处理
